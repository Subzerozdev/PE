...
public partial class AirConditionerShop2024DbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        // pas hàm dưới vào đây nhé 
        => optionsBuilder.UseSqlServer(GetConnectionString());


    // đây là hàm mới nè copy từ file note nhé
    private string GetConnectionString()
    {
        IConfiguration config = new ConfigurationBuilder()
             .SetBasePath(Directory.GetCurrentDirectory())
                    ...
                    .Build();
        var strConn = config["ConnectionStrings:DefaultConnectionStringDB"];  // coi đây có dấu cách gì không á // so sánh appsettings với đoạn này 
        //                       Dấu cách và 9 triệu ( 6 triệu + 3 triệu) 
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AirConditionerId).HasName("PK__AirCondi__EE2EB739C554735B");
        ...
        {
            entity.HasKey(e => e.MemberId).HasName("PK__StaffMem__0CF04B38C0F11B39");

            entity.ToTable("StaffMember");

            entity.HasIndex(e => e.EmailAddress, "UQ__StaffMem__49A1474021C5A641").IsUnique();
        ...
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__Supplier__4BE666B43676229B");
